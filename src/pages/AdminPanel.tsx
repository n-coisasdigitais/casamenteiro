    ...
    <div className="min-h-screen bg-background">
      <header className="bg-card border-b border-border sticky top-0 z-40">
        <div className="container flex items-center justify-between h-16 px-4">
          ...
          <div className="flex items-center gap-2 flex-wrap"><Button variant="outline" size="sm" asChild><Link to="/admin/metricas">Métricas & Cadastros</Link></Button><Button variant="outline" size="sm" asChild><Link to="/admin/home-config">Home</Link></Button><Button variant="outline" size="sm" asChild><Link to="/admin/fornecedores">Edição em massa</Link></Button><Button variant="outline" size="sm" asChild><Link to="/admin/simulacoes">Simulações</Link></Button><Button variant="outline" size="sm" asChild><Link to="/admin/transacoes">Transações</Link></Button><Button variant="ghost" size="icon" onClick={signOut}><LogOut className="h-4 w-4" /></Button></div>
        </div>
      </header>
