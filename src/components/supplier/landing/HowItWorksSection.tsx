...
const STEPS = [
  {
    ...
    description: "Preencha as informações do seu serviço em poucos minutos. Sem cartão de crédito.",
    emoji: "✏️",
    preview: "Complete seu perfil",
  },
  {
    label: "Passo 02",
    title: "A gente aprova",
    description: "Nossa equipe revisa e publica seu perfil na plataforma em até 24h.",
    emoji: "✅",
    preview: "Aprovação em 24h",
  },
  {
    label: "Passo 03",
    title: "Os casais te encontram",
    description: "Receba contatos de casais com orçamento definido e data já marcada.",
    emoji: "💌",
    preview: "Casais te encontram",
  },
];
  ...
  return (
    <section id="como-funciona" className="py-24 px-4 bg-secondary">
      <div className="max-w-5xl mx-auto">
        ...
        >
          <span className="text-xs uppercase tracking-wider text-muted-foreground">Como funciona</span>
          <h2 className="font-serif text-3xl md:text-4xl mt-3 mb-4">
            Comece a receber contatos em 3 passos simples
          </h2>
          <p className="text-base text-muted-foreground max-w-xl mx-auto">
            Nosso processo é rápido, sem burocracia e 100% gratuito para começar.
          </p>
        </motion.div>
